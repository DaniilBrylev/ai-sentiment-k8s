...
В рамках проекта разработано и развернуто контейнерное Java-приложение для анализа тональности текста с использованием Kubernetes (Minikube). Проект охватывает полный цикл работ: разработку REST API, контейнеризацию, развертывание в Kubernetes, настройку балансировки нагрузки, автоскейлинга и мониторинга, а также аналитический обзор современных тенденций в области ИИ и контейнеризации.
...
Для мониторинга состояния приложения и кластера используется стек Prometheus + Grafana.
...
В рамках проекта выполнен аналитический обзор научных публикаций arXiv за 2024–2025 годы, посвященных следующим направлениям:
...
├── README.md
└── report/
    ├── Отчет_AI_K8s_Minukube.docx
    └── Презентация_AI_K8s.pptx
